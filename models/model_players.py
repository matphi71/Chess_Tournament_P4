...
class PlayersIdentity:
    ...
    """ A player has a Family name, a name, a birth date, a gender and a ranking.
    In this class we can add a player to the database """

    def __init__(
        self, family_name=None, name=None, birth_date=None, gender=None, ranking=None
    ):
    ...
    def deserialized_player(self):
        ...
        deserialized_player = PlayersIdentity(
