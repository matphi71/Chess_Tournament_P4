...
class ViewMenu:
    ...
    def welcome_message():
        ...
        print(
            "\n\n"
            + colored(
                f.renderText("WELCOME  TO  YOUR  TOURNAMENT SYSTEM     MANAGER"),
                "yellow",
            )
        )
    ...
    def menu_options():
        print(
            "\n"
            + " " * 50
            + colored("*** CHESS TOURNAMENT MANAGER MENU ***", "blue")
            + "\n"
        )
        answer = input(
            (
    ...
    def print_report_alphabetical_list():
        ...
        alphabetical_participants_players_list = sorted(
            alphabetical_participants_players_list, key=lambda k: k["family_name"]
        )
        print(
        ...
        for participants in alphabetical_participants_players_list:
            print(
                ...
                participants["name"] + " - birth date:",
                participants["birth_date"] + " - ranking:",
    ...
    def print_report_ranking_list():
        ...
        ranking_participant_players_list = sorted(
            ranking_participant_players_list, key=lambda k: int(k["ranking"])
        )
